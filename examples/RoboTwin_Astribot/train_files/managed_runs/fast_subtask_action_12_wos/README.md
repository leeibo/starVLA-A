...
`examples/RoboTwin_Astribot/train_files/managed_runs/fast_subtask_action_12_wos/logs/`.
...
`results/Checkpoints/fast_subtask_action_12_wos` unless `POLICY_CKPT_PATH` is
set. Default port is `7980`.

Outputs are written to `results/Checkpoints/fast_subtask_action_12_wos`.
