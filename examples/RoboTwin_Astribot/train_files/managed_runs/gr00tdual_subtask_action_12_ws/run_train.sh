...
# Multi-node support: set NUM_MACHINES>1 + MACHINE_RANK + MAIN_PROCESS_IP
# from the multi-node launcher; defaults keep the single-node path unchanged.
NUM_MACHINES="${NUM_MACHINES:-1}"
MACHINE_RANK="${MACHINE_RANK:-0}"
MAIN_PROCESS_PORT="${MAIN_PROCESS_PORT:-${MASTER_PORT:-28503}}"
