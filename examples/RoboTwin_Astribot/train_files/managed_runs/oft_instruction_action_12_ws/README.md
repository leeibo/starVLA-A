...
```bash
bash examples/RoboTwin_Astribot/train_files/managed_runs/oft_instruction_action_12_ws/run_train.sh
```

Submit:

```bash
yhbatch examples/RoboTwin_Astribot/train_files/managed_runs/oft_instruction_action_12_ws/submit_yhbatch.sh
```

Inference server:

```bash
bash examples/RoboTwin_Astribot/train_files/managed_runs/oft_instruction_action_12_ws/run_policy_server.sh
```
