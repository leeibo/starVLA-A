#!/usr/bin/env bash
#SBATCH --job-name=fast_subtask_action_12_ws
#SBATCH -p a800x
#SBATCH -c 8
#SBATCH --gres=gpu:1
#
...
#
# Override resources or runtime:
#   NUM_PROCESSES=1 WANDB_MODE=offline yhbatch -p a800x -c 8 --gres=gpu:1 \
#     examples/RoboTwin_Astribot/train_files/managed_runs/fast_subtask_action_12_ws/submit_yhbatch.sh

set -euo pipefail

REPO_ROOT="${STARGVLA_REPO_ROOT:-/XYAIFS00/HDD_POOL/hlkj_zql/hlkj_zql_8/code/starVLA}"
RUN_NAME="fast_subtask_action_12_ws"
