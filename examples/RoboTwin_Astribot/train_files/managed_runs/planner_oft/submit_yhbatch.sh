...
STDOUT_LOG="${LOG_DIR}/${RUN_NAME}-${STAGE}-${JOB_ID}-${TIMESTAMP}.out"
STDERR_LOG="${LOG_DIR}/${RUN_NAME}-${STAGE}-${JOB_ID}-${TIMESTAMP}.err"
...
export PLANNER_OFT_STAGE="${STAGE}"
