...
```bash
bash examples/RoboTwin_Astribot/train_files/managed_runs/oft_subtask_action_12_ws/run_train.sh
```
...
```bash
bash examples/RoboTwin_Astribot/train_files/managed_runs/oft_subtask_action_12_ws/run_policy_server.sh
```
...
Outputs are written to `results/Checkpoints/oft_subtask_action_12_ws`.
