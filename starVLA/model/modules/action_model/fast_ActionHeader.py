...
def _load_fast_processor(pretrained_path: str = "./playground/Pretrained_models/fast"):
    ...
    """
    if not os.path.exists(pretrained_path) and pretrained_path == "./playground/Pretrained_models/fast":
        pretrained_path = "physical-intelligence/fast"
